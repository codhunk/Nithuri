  ...
  return (
    <div className="flex flex-col min-h-screen bg-white transition-colors duration-300">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20">
        <h1 className="text-4xl font-black mb-8 underline decoration-primary decoration-4 underline-offset-8">Terms of Service</h1>
        <div className="prose prose-slate max-w-none space-y-6 text-slate-600 font-medium">
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">2. Use of Services</h2>
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">3. Property Listings</h2>
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">4. Intellectual Property</h2>
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">5. Limitation of Liability</h2>
