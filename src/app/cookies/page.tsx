  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-background-dark transition-colors duration-300">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20">
        <h1 className="text-4xl font-black mb-8 dark:text-white underline decoration-primary decoration-4 underline-offset-8">Cookie Policy</h1>
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-400 font-medium">
          ...
          <h2 className="text-2xl font-black text-slate-900 dark:text-white pt-6">1. What Are Cookies?</h2>
          ...
          <h2 className="text-2xl font-black text-slate-900 dark:text-white pt-6">2. Why Do We Use Cookies?</h2>
