  ...
  return (
    <div className="flex flex-col min-h-screen bg-white transition-colors duration-300">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20 w-full">
        <h1 className="text-4xl font-black mb-8 underline decoration-primary decoration-4 underline-offset-8">Complaints Procedure</h1>
        <div className="prose prose-slate max-w-none space-y-6 text-slate-600 font-medium">
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">How to Make a Complaint</h2>
          ...
          <h2 className="text-2xl font-black text-slate-900 pt-6">What Happens Next?</h2>
        ...
        <div className="mt-20 p-8 border-2 border-primary/20 rounded-[2rem] bg-slate-50 flex flex-col md:flex-row items-center justify-between gap-8">
           <div>
              <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1 pl-1">Need Faster Help?</p>
              <h3 className="text-2xl font-black">Our Support Team is Online</h3>
           </div>
