...
export default function AddPropertyPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-8 pb-12 transition-all duration-300">
      {error && (
        <div className="p-4 bg-red-50 border border-red-100 rounded-xl text-red-700 text-sm font-bold flex items-center gap-2 animate-shake">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-100">
          <div className="flex items-center gap-3 mb-10 border-b border-slate-50 pb-5">
            ...
            <div>
              <h2 className="text-xl font-black leading-tight">Property Details</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col gap-3">
                ...
                <select
                  className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 text-sm outline-none focus:ring-4 focus:ring-primary/20 focus:border-primary transition-all appearance-none"
                ...
                >
                  {[
                    ...
                    <option key={t.val} value={t.val} className="">{t.lab}</option>
                  ))}
                </select>
              </div>
              <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-10 pr-5 py-4 text-sm outline-none focus:ring-4 focus:ring-primary/20 focus:border-primary transition-all"
                    value={form.price}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    {["sqft", "sqm", "bigha", "acre", "marla"].map(u => (
                      <option key={u} value={u} className="">{u}</option>
                    ))}
                  </select>
                </div>
              </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-100">
          <div className="flex items-center gap-3 mb-10 border-b border-slate-50 pb-5">
            ...
            <h2 className="text-xl font-black">Property Media</h2>
          </div>

          <div className="space-y-6">
            <label className="block border-2 border-dashed border-slate-200 rounded-xl p-16 text-center hover:border-primary/50 transition-all cursor-pointer bg-slate-50/50 group">
              <input type="file" multiple accept="image/*" className="hidden" onChange={handleFileChange} />
              <div className="w-20 h-20 bg-white rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-xl group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-4xl text-primary">add_photo_alternate</span>
              </div>
              <h3 className="text-lg font-black mb-1">Upload Property Images</h3>
            ...
            {previews.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-6">
                {previews.map((src, i) => (
                  <div key={i} className="relative aspect-square rounded-3xl overflow-hidden group border-2 border-slate-100 shadow-lg">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-100">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-3">
                <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest pl-1">State / Region</label>
                <input
                  required
                  type="text"
                  className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 text-sm outline-none focus:ring-4 focus:ring-primary/20 focus:border-primary transition-all"
            ...
            <div className="flex flex-col gap-3">
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest pl-1">Street / Landmark</label>
              <input
                required
                type="text"
        ...
        <div className="flex justify-end gap-6 items-center pb-20">
          <button
            type="button"
            onClick={() => router.back()}
            className="px-8 py-3 rounded-2xl font-black text-sm text-slate-500 hover:bg-slate-100 transition-all"
          >
            Go Back
          </button>
          <button
