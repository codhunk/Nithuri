  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((card) => (
          <div key={card.label} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 transition-colors">
            ...
            <p className="text-2xl font-bold mb-1 uppercase tracking-tight">{card.value}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Recent Listings */}
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-100 p-6 transition-colors">
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="font-bold text-slate-900 mb-1">No Listings Found</h3>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 transition-colors">
          <h2 className="font-black text-lg mb-4">Quick Guide</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-transparent hover:border-primary/10 transition-all">
